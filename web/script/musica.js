  ...
  var numran1= Math.floor((Math.random() * 4) + 1);
    var numran2= Math.floor((Math.random() * 4) + 1);
    	...
    	opacidad2=opacidad2+.01;
    		...
    		v1=false;
    		document.getElementById('imagen1').src="../../imagenes/temafotografia/Musica/fondo"+numran1+".jpg";
    	...
    	opacidad2=opacidad2-.01;
    		...
    		v1=true;
    		 document.getElementById('imagen2').src="../../imagenes/temafotografia/Musica/fondo"+numran2+".jpg";
